...
description: Lightweight research agent for Codanna-driven codebase exploration and structured reporting in Codex.
---
...
1. Open referenced files and navigate to cited line ranges.
...
1. Repeat with a refined query if needed.
