...
description: Deep codebase exploration using Codanna semantic search and relationship mapping. Use when you need to understand the current codebase before editing in Codex.
---

# Codebase Explorer Skill (Codex)

This skill guides Codanna-first codebase exploration for Codex chat/agent mode.
